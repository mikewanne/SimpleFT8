...
class StationStatsLogger:
    ...
    # 28.04.2026 nachmittags: 17m hinzugefuegt.
    # 28.04.2026 abends: alle 9 HF-Baender frei (Mike-Wunsch — Off-Band/
    # Resonant-Hypothese ueber das gesamte Spektrum testen, inkl. 12m/60m/80m).
    LOGGED_BANDS = frozenset({
