...
void monitor_init(monitor_t* me, const monitor_config_t* cfg)
{
    ...
    switch (cfg->protocol) {
    case FTX_PROTOCOL_FT4: slot_time = FT4_SLOT_TIME; symbol_period = FT4_SYMBOL_PERIOD; break;
    case FTX_PROTOCOL_FT2: slot_time = FT2_SLOT_TIME; symbol_period = FT2_SYMBOL_PERIOD; break;
    default:               slot_time = FT8_SLOT_TIME; symbol_period = FT8_SYMBOL_PERIOD; break;
    }
