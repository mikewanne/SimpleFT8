...
**Aktueller Stand:** **v0.97.59 Session 19.05.2026 — P89: Diversity-Count-Labels vereinfacht.** Mike-Beobachtung nach P88: ANT2-Win-% (P85) + DX-Counts (P87) erzeugten Verwirrung weil sie 1-3 Zyklen vor dem Ratio-Sprung liefen (Hysterese 8%). 10 Slots ANT2-Win 25% angezeigt, Ratio hing 50:50 → „ist was kaputt"-Eindruck. Fix KISS Variante C (DeepSeek-Brainstorm-R1): „Berechnung läuft..." während Warmup, sonst beide Labels leer. ANT2-Win-%-Berechnung + DX-Weak-Counts raus. `--`-Early-Return entfernt → Zero-Counts hängen konsistent im Warmup. Ringpuffer + Warmup-Counter bleiben (Lifecycle unverändert). Final-R1 „PUSH FREIGEBEN" 0 KP. **V4-pro 35-Cycle-Bilanz: 0 Halluzinationen.** Tests 1574→1580 (+6 P89 netto, 9 angepasste alte). Field-Test F1-F6 pending (alle ohne Radio). **Vorgänger v0.97.58 P88** Responsive Hide.
