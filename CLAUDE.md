...
**Aktueller Stand:** **v0.96.10 Session 11.05.2026 ~05:35 UTC — viele Trivial-Fixes + P30 Memory-Leak offen.** Heute auf v0.96.10 drauf: Diversity-Anzeige nur Minuten, OMNI-CQ-Button grün/dunkelrot, QSO-Panel Spalten schmaler, Funkmast-Icon (Lucide ISC) im Connect-Modal, P29 OMNI-Panel-Paritäts-Trennung (Leerzeile + Even-Farbton dunkler), **P28 PSK-Bug-Fix** (`_has_sent_cq` auch bei OMNI-TX — Bug latent seit OMNI-Refactor), **P12 Partial-Fix** (Logbuch nur letzte 500 QSOs — 60s-Hang weg), PSK + QSO-Hang Debug-Logs (Bisection-Pattern). Tests **1070 grün**. **Kritisch offen: P30 MEMORY-LEAK 124 GB nach Tagen** (RAM nicht Disk, Live-Check bestätigt) — eigener Workflow nötig vor Push.
