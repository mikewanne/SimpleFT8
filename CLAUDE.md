...
**Aktueller Stand:** **v0.97.58 Session 19.05.2026 — P88 autonom: Responsive Hide bei schmaler Spalte.** Mike-Field-Test (Screenshots 14:17): Diversity-Count-Labels in der Ratio-Row bei schmaler Control-Panel-Spalte gequetscht/unlesbar. Fix KISS: Klassen-Konstante `_COUNT_LABEL_HIDE_THRESHOLD = 380`, `resizeEvent` triggert `_update_count_label_visibility` → `setHidden(narrow)`. Initial-Call in __init__ verhindert Aufflackern. Brainstorm-R1 V4-pro Variante A 🟢 mit Konstante. V2 0 Findings. Final-R1 „PUSH FREIGEBEN ✅" 0 KP. **V4-pro 34-Cycle-Bilanz: 0 Halluzinationen.** Tests 1568→1574 (+6 P88). Field-Test F1-F4 pending. **Vorgänger v0.97.57 P87** DX-Warmup.
