...
**Aktueller Stand:** **v0.96.10 P26.CONNECT-MODAL Field-Test ✅ + Tweak (11.05.2026)** — Modaler Dialog beim App-Start, Mike Field-Test „funktioniert super". Tweak v0.96.10: Versuch-Counter raus (set_attempt no-op), Fenster 352×176 (20% kleiner). Spinner + „ohne Radio weiter"-Link + „Beenden"-Button.
