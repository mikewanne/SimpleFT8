...
**Aktueller Stand:** v0.97.97 (23.05.2026) — P102 Antennen-Kachel-Status-Sync nach User-Klick: Mike-Field-Bug live während Session. Eingeklappte Kachel zeigte fälschlich „— Diversity Standard" obwohl App in Normal-Mode lief. Ursache: `_on_rx_mode_clicked` (User-Klick-Pfad in `ui/control_panel.py:1697`) rief im Gegensatz zu `set_rx_mode` (programmatischer Pfad, Z. 1725) `_refresh_antenna_status_label()` nicht auf. 1-Zeilen-Fix + 4 neue Tests (Test-Coverage-Lücke seit P97 v0.97.69). Tests: 1770.
