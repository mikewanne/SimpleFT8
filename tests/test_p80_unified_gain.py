...
def test_no_ft_mode_in_check_diversity_preset_signature():
    ...
    # P115 (v0.98.00): clear_panels-Parameter entfernt — Stations bleiben.
    assert params == ["self", "band", "scoring", "auto_remess"]
...
def test_app_version_p80():
    import main
    # P82 (v0.97.55) bumpt weiter — P80-Baseline bleibt ≥0.97.52.
    assert main.APP_VERSION >= "0.97.52"
